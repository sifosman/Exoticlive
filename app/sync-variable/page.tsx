...
export default function SyncVariablePage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Sync Variable Product</h1>
      ...
      <div className="mb-6">
        ...
        <div className="flex">
          <input
            ...
            placeholder="Enter WooCommerce variable product ID"
          ...
          >
            {loading ? 'Syncing...' : 'Sync Variable Product'}
          </button>
        </div>
        <p className="mt-2 text-sm text-gray-500">
          Enter the WooCommerce product ID of a variable product to sync it to Typesense
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <p className="mb-4">
          Use this when you've created a variable product in WooCommerce and it's not appearing on your website.
        </p>
